...
Template Name: Home Page 2 Demo Only
...
<?php if ( is_sidebar_active('Featured Products') ) : ?>
<section id="featured">
	<div class="container_12">
		<div class="grid_12">

			<?php // wpsc_display_featured_products_page(); ?>
...
<section id="subcontent2">
	<div class="container_12">
		<?php if( is_sidebar_active('Home Subcontent 2') ) : ?>
		<div class="grid_<?php if( is_sidebar_active('Home Subcontent Sidebar')): ?>9<?php else: ?>12<?php endif; ?>">
			<?php dynamic_sidebar( 'Home Subcontent 2' ); ?>
			<div class="clear"></div>
		</div>
		<?php endif; ?>
		<?php if( is_sidebar_active('Home Subcontent Sidebar') ) : ?>
		<div class="grid_3">
			<?php dynamic_sidebar( 'Home Subcontent Sidebar' ); ?>
			<div class="clear"></div>
		</div>
		<?php endif; ?>
		<div class="clear"></div>
...
<?php if( is_sidebar_active('Home Before Footer') ) : ?>
	<div class="grid_12 beforefooter">
