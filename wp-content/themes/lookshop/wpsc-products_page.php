	...
	<?php endif ; ?>">   
				...
				<?php endif; ?>
					...
					<div class="productcol" style="margin-left:<?php echo $image_width + 20; ?>px;" >
                       ...
                       <script>
	                        <?php if ((get_option('show_desc') == 'on') && ((int)get_option('words_trim_grid') != 0)) : ?>
				    			jQuery('product_view_<?php echo wpsc_the_product_id() ?> .wpsc_description').text(trim_words(jQuery('product_view_<?php echo wpsc_the_product_id() ?> .wpsc_description').text(), <?php echo get_option('words_trim_grid'); ?>));
				    		<?php else: ?>
				    			jQuery('product_view_<?php echo wpsc_the_product_id() ?> .wpsc_description').text(trim_words(jQuery('product_view_<?php echo wpsc_the_product_id() ?> .wpsc_description').text(), 0));
				    		<?php endif; ?>
                        </script>
