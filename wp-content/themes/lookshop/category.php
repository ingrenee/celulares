	...
	<?php if(get_option('isotope_blog') == 'yes'): ?>
		<div class="grid_12 cont_col" />
			<div class="posts-title">
				<h1 class="category-title"><?php printf( __( '%s', 'lookshop' ), '' . single_cat_title( '', false ) . '' ); ?></h1>
				<div class="filters">
					<div class="categories-filter">
						<?php 
				
						
							$args = array('orderby' => 'ASC', 'child_of' => $wp_query->query_vars['cat']);
...
<?php get_footer(); ?>
	...
	<div class="title border">
		<h1 class="category-title lower-case">
			<?php printf( __( '%s' ,'lookshop'), '<span>' . single_cat_title( '', false ) . '</span>' ); ?>
		</h1>
	</div>
