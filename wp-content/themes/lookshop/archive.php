	...
	<?php if(get_option('isotope_blog') == 'yes'): ?>
		...
		<h1 class="category-title lower-case">
			<?php if ( is_day() ) : /* if the daily archive is loaded */ ?>
				<?php printf( __( 'Daily Archives: <span>%s</span>' ,'lookshop'), get_the_date() ); ?>
			<?php elseif ( is_month() ) : /* if the montly archive is loaded */ ?>
				<?php printf( __( 'Monthly Archives: <span>%s</span>' ,'lookshop'), get_the_date('F Y') ); ?>
			<?php elseif ( is_year() ) : /* if the yearly archive is loaded */ ?>
				<?php printf( __( 'Yearly Archives: <span>%s</span>','lookshop' ), get_the_date('Y') ); ?>
			<?php else : /* if anything else is loaded, ex. if the tags or categories template is missing this page will load */ ?>
				<?php _e('Blog Archives','lookshop'); ?>
			<?php endif; ?>
		</h1>
...
<script>
				...
				jQuery('.categories-filter').hover(
					function(){
