...
<div class="widget_recent_entries textwidget">
<?php
...
while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
	...
	<?php if ($show_post_thumb && has_post_thumbnail()) { ?>
		<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('homepage-thumb', array('title' => '', 'class' => 'alignleft')); ?></a>
	<?php } ?>
	
	<?php if ($show_post_title) { ?>
		<span class="recent-title"><a href="<?php the_permalink() ?>" rel="bookmark"
