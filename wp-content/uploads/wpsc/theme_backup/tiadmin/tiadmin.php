...
if (!class_exists('TiAdminPanel')){
	...
	//----Implementation-------
		...
		public static function lookshopListing(){
			...
			$html .= '<p><label>'.__('Set a number of words in product description on Prodouct Listing:', 'lookshop').'</label>
		...
		public static function lookshopBlog(){
			$html = '';
			$html .= '<h4>'.__('Theme Specific Blog Settings', 'lookshop').'</h4>';
			$html .= '<p>'.__('Here you can adjust different theme specific settings', 'lookshop').'</p>';
		...
		public static function BuildDashboardPage(){
			...
			TiAdminPanel::TiAddAdminSection(__('Blog posts Listing Settings', 'lookshop'), TiAdminPanel::lookshopBlog());
