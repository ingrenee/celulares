...
if (function_exists('wpcf7_add_shortcode')) wpcf7_add_shortcode( 'submit', 'wpcf7_submit_chrome_shortcode_handler' );
...
function wpcf7_submit_chrome_shortcode_handler( $tag ) {
	...
	$html = '<button '.$atts.'><span>'.esc_attr( $value ).'</span></button>';
